...
namespace DiagramNet.Elements {
    ...
    [Browsable(false)]
    public override Point Point2 => lines[^1].Point2;
    ...
    public override Color BorderColor {
		...
		public override Point Location {
			...
			set {
				...
				Point locDiff = new(locAfter.X - locBefore.X, locAfter.Y - locBefore.Y);

      ...
      return ret;
		...
		public class ArrayHelper {
			...
			public static Array Append(Array arr1, Array arr2) {
				...
				if (arr1Type == null || arr2Type == null) throw new Exception("unknow types");
				ArrayList arrNew = new(arr1.Length + arr2.Length - 1);
			...
			public static Array Shrink(Array arr, object? removeValue) {
				ArrayList arrNew = new(arr.Length - 1);
        ...
        Type? ArrType = arr.GetType().GetElementType();
				if (ArrType == null) throw new Exception("Invalid Array Type");
				return arrNew.ToArray(ArrType);
			}
		}
	}
}

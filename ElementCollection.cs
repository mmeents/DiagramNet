...
namespace DiagramNet {
	...
	public class ElementCollection : ReadOnlyCollectionBase {
		private Point location = new(maxIntSize, maxIntSize);
      ...
      (InnerList[i], InnerList[y]) = (InnerList[y], InnerList[i]);
    }

    #region Implementation of IEnumerator
    public class BaseElementEnumarator : IEnumerator {

			private readonly IEnumerator baseEnumarator;
			private readonly IEnumerable tmp;

			public BaseElementEnumarator(ElementCollection mapping) : base() {
